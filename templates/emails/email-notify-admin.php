...
<body style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
    <div clas="container" style="display: block; margin: 0 auto !important; max-width: 580px; padding: 10px; width: 580px; background: #ffffff; border-radius: 3px;">
        <table style="border-collapse: separate;
            ...
            padding: 0.5rem;">Website url</td>
                    <td style="font-family: sans-serif;
            font-size: 14px;
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__($siteurl, 'btcpaywall'); ?></td>
                </tr>
                <tr>
                    <td style="font-family: sans-serif;
            font-size: 14px;
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;">Date</td>
                    <td style="font-family: sans-serif;
            font-size: 14px;
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__($date, 'btcpaywall'); ?></td>
                </tr>
                <tr>
                    <td style="font-family: sans-serif;
            font-size: 14px;
            ...
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__($amount, 'btcpaywall'); ?></td>
                </tr>
                <?php if ($storeId) : ?>
                    <tr>
                        <td style="font-family: sans-serif;
            ...
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;">Credit on Store ID</td>
                        <td style="font-family: sans-serif;
            font-size: 14px;
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__($storeId, 'btcpaywall'); ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td style="font-family: sans-serif;
            ...
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__($type, 'btcpaywall'); ?></td>
                </tr>
            </tbody>
        </table>
        <?php if ($collect_data) : ?>
            ...
            font-family: sans-serif;
            font-weight: 400;
            line-height: 1.4; font-size: 20px; border: 1px solid #000000;" colspan="2"><?php echo esc_html__($header, 'btcpaywall'); ?></th>
                    </tr>
                </thead>
                <tbody>
            ...
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo esc_html__(ucfirst($key), 'btcpaywall'); ?></td>
                                    <td style="font-family: sans-serif;
            font-size: 14px;
            vertical-align: top;
            border: 1px solid #999;
            padding: 0.5rem;"><?php echo (esc_html__($value, 'btcpaywall')); ?></td>
                                </tr>
