    ...
    <div class="btcpw_revenue_post_container">
        <form method="POST" action="" id="post_revenue_type">
            <fieldset>
                ...
                <div class="btcpw_pay__footer">
                    ...
                    <?php if (true === $collect_data) : ?>
                        ...
                        <div>
                            <input type="button" name="next" class="<?php echo "revenue-post-next-form"; ?>" value="Continue">
                        </div>
            ...
            <?php if ($collect_data === true) : ?>
                <fieldset>
                    <div class="<?php echo ltrim("btcpw_revenue_post_customer_information"); ?>">
                    ...
                    <div class="<?php echo "btcpw_revenue_post_button"; ?>" id="btcpw_revenue_post_button">
                        <div>
