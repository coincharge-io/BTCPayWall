				...
				<Panel>
					...
					<PanelBody title="Footer">
						...
						<ColorPicker
							...
							disableAlpha
						/>
						<p> Continue button text color </p>{' '}
						<ColorPicker
							color={button_text_color}
							onChangeComplete={(value) =>
								setAttributes({
						...
						<ColorPicker
							...
							disableAlpha
						/>
						<p> Previous button text color </p>{' '}
						<ColorPicker
					...
					<PanelBody title="Fixed amount">
						<CheckboxControl
							...
							checked={show_icon}
							onChange={(newvalue) =>
								setAttributes({ show_icon: newvalue })
							}
						/>
						<CheckboxControl
						...
						<TextControl
							...
							value={value1_icon}
							onChange={(value) =>
								setAttributes({ value1_icon: value })
							}
						/>
						...
						<TextControl
							...
							value={value2_icon}
							onChange={(value) =>
								setAttributes({ value2_icon: value })
							}
						/>
						...
						<TextControl
							...
							value={value3_icon}
							onChange={(value) =>
								setAttributes({ value3_icon: value })
							}
						/>
					</PanelBody>

					<PanelBody title="Donor information">
						<PanelRow>
							<CheckboxControl
								label="Full name"
