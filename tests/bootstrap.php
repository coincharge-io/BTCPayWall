 ...
 */
function btcpaywall_manually_load_plugin()
{
	require dirname(dirname(__FILE__)) . '/btcpaywall.php';
}

tests_add_filter('muplugins_loaded', 'btcpaywall_manually_load_plugin');
