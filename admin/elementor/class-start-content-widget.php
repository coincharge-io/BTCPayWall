...
class Elementor_BTCPW_Start_Content_Widget extends \Elementor\Widget_Base
{
	...
	protected function render()
	{
		...
		if ($enable_pay_block) {
			echo do_shortcode("[btcpw_start_content pay_block='true' currency='{$currency}' btc_format='{$btc_format}' duration='{$duration}' duration_type='{$duration_type}' price='{$price}']");
		}
	}
}
