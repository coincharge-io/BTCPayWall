        ...
        <div class="btcpw_widget btcpw_skyscraper_tipping_container high">
            <form method="POST" action="" id="btcpw_widget_skyscraper_tipping_form_high">
                <fieldset>
                    ...
                    <div class="btcpw_widget btcpw_skyscraper_amount high">
                        ...
                        <div class="<?php echo "btcpw_widget btcpw_skyscraper_amount_$key high"; ?>">
                            <div>
                                <input type="radio" class="btcpw_widget btcpw_skyscraper_tipping_default_amount high"
                                    id="<?php echo "btcpw_widget_{$key}_high"; ?>"
                                    name="btcpw_widget_btcpw_skyscraper_tipping_default_amount_high"
                        ...
                        <div class="btcpw_widget btcpw_skyscraper_tipping_free_input high">
                            ...
                            <select required name="btcpw_widget_btcpw_skyscraper_tipping_currency_high"
                                id="btcpw_widget_btcpw_skyscraper_tipping_currency_high" ; ?>">
                    ...
                    <div class="btcpw_widget btcpw_skyscraper_tipping_converted_values high">
                        <input type="text" id="btcpw_widget_btcpw_skyscraper_converted_amount_high"
                            name="btcpw_widget_btcpw_skyscraper_converted_amount_high" readonly />
                        <input type="text" id="btcpw_widget_btcpw_skyscraper_converted_currency_high"
                            name="btcpw_widget_btcpw_skyscraper_converted_currency_high" readonly />
                    </div>
                    ...
                    <div id="btcpw_widget_btcpw_skyscraper_button_high">
                        ...
                        <div>
                            <button type="submit"
                                id="btcpw_widget_btcpw_skyscraper_tipping__button_high"><?php echo (!empty($instance['button_text']) ? ($instance['button_text']) : 'Tip'); ?></button>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <fieldset>
                    ...
                    <div id="btcpw_widget_btcpw_skyscraper_button_high">
                        <div>
                            <input type="button" name="previous" class="btcpw_widget_ skyscraper-previous-form high"
                                value="< Previous" />
                        </div>
                        <div>
                            <button type="submit"
...
<div class="tipping_banner">
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($logo_id) : ?>
            <button id="lnpw_tipping_button_logo_banner_high" class="widget-tipping-basic-upload_box_logo_high"
