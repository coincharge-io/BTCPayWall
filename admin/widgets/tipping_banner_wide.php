                        ...
                        <fieldset>
                            ...
                            <div class="btcpw_widget btcpw_skyscraper_amount wide">
                                <?php foreach ($fixed_amount as $key => $value) : ?>
                                    ...
                                    <?php if (filter_var($fixed_amount[$key]['enabled'], FILTER_VALIDATE_BOOL) === true) : ?>
                                    ...
                                    <?php foreach ($collect as $key => $value) : ?>
                                        <?php if (filter_var($collect[$key]['display'], FILTER_VALIDATE_BOOL) === true) : ?>
                                            <div class="<?php echo "btcpw_widget btcpw_skyscraper_tipping_donor_{$collect[$key]['label']}_wrap wide"; ?>">
                                                ...
                                                <input type="text" placeholder="<?php echo $collect[$key]['label']; ?>" id="<?php echo "btcpw_widget_btcpw_skyscraper_tipping_donor_{$collect[$key]['id']}_wide"; ?>" name="<?php echo "btcpw_widget_btcpw_skyscraper_tipping_donor_{$collect[$key]['id']}_wide"; ?>" <?php echo filter_var($collect[$key]['mandatory'], FILTER_VALIDATE_BOOL) === true ? 'required' : ''; ?> />
