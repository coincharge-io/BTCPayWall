...
class Tipping_Banner_Wide extends WP_Widget
{
    ...
    {
        /*echo do_shortcode("[btcpw_tipping_skyscraper dimension='600x200' title = '{$instance['title']}' description	= '{$instance['description']}'
            ...
            <form method="POST" action="" id="btcpw_widget_skyscraper_tipping_form_wide">
                <fieldset>
                    ...
                    <div class="btcpw_widget btcpw_skyscraper_amount wide">
                        ...
                        <div class="<?php echo "btcpw_widget btcpw_skyscraper_amount_$key wide"; ?>">
                            <div>
                                <input type="radio" class="btcpw_widget btcpw_skyscraper_tipping_default_amount wide"
                                    id="<?php echo "btcpw_widget_{$key}_wide"; ?>"
                                    name="btcpw_widget_btcpw_skyscraper_tipping_default_amount_wide"
                                    <?php echo $key == $index ? 'required' : ''; ?>
                                    value="<?php echo ($fixed_amount[$key]['amount'] . ' ' . $fixed_amount[$key]['currency']); ?>">
                                <?php if (!empty($fixed_amount[$key]['amount'])) : ?>
                                <i class="<?php echo ($fixed_amount[$key]['icon']); ?>"></i>
                                <?php endif; ?>
                            </div>
                            <label
                                for="<?php echo $key; ?>"><?php echo ($fixed_amount[$key]['amount'] . ' ' . $fixed_amount[$key]['currency']); ?></label>
                        ...
                        <div class="btcpw_widget btcpw_skyscraper_tipping_free_input wide">
                            <input type="number" id="btcpw_widget_btcpw_skyscraper_tipping_amount_wide"
                                name="btcpw_widget_btcpw_skyscraper_tipping_amount_wide" placeholder="0.00" required />


                            <select required name="btcpw_widget_btcpw_skyscraper_tipping_currency_wide"
                                id="btcpw_widget_btcpw_skyscraper_tipping_currency_wide" ; ?>">
                                <option disabled value="">Select currency</option>
                                <?php foreach ($supported_currencies as $currency) : ?>
                                <option <?php echo $instance['currency'] === $currency ? 'selected' : ''; ?>
                    ...
                    <div class="btcpw_widget btcpw_skyscraper_tipping_converted_values wide">
                        <input type="text" id="btcpw_widget_btcpw_skyscraper_converted_amount_wide"
                            name="btcpw_widget_btcpw_skyscraper_converted_amount_wide" readonly />
                        <input type="text" id="btcpw_widget_btcpw_skyscraper_converted_currency_wide"
                            name="btcpw_widget_btcpw_skyscraper_converted_currency_wide" readonly />
                    </div>


                    <div id="btcpw_widget_btcpw_skyscraper_button_wide">
                        <input type="hidden" id="btcpw_widget_btcpw_skyscraper_redirect_link_wide"
                            name="btcpw_widget_btcpw_skyscraper_redirect_link_wide"
                            value=<?php echo ($instance['redirect']); ?> />
                        <?php if ($collect_data == 'true') : ?>
                        <div>
                            <input type="button" name="next" class="btcpw_widget skyscraper-next-form wide"
                                value="Continue >" />
                        </div>
                        <?php else : ?>
                        <div>
                            <button type="submit"
                                id="btcpw_widget_btcpw_skyscraper_tipping__button_wide"><?php echo (!empty($instance['button_text']) ? ($instance['button_text']) : 'Tip'); ?></button>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <fieldset>
                    <div class="btcpw_widget btcpw_skyscraper_donor_information wide">
                        ...
                        <div
                            class="<?php echo "btcpw_widget btcpw_skyscraper_tipping_donor_{$collect[$key]['label']}_wrap wide"; ?>">

                            <input type="text" placeholder="<?php echo $collect[$key]['label']; ?>"
                                id="<?php echo "btcpw_widget_btcpw_skyscraper_tipping_donor_{$collect[$key]['id']}_wide"; ?>"
                                name="<?php echo "btcpw_widget_btcpw_skyscraper_tipping_donor_{$collect[$key]['label']}_wide"; ?>"
                    ...
                    <div id="btcpw_widget_btcpw_skyscraper_button_wide">
                        <div>
                            <input type="button" name="previous" class="btcpw_widget_ skyscraper-previous-form wide"
                                value="< Previous" />
                        </div>
                        <div>
                            <button type="submit"
...
<div class="tipping_banner">
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($background) : ?>
            <button id="lnpw_tipping_button_image_background_banner_wide"
                class="widget-tipping-basic-upload_box_image_wide" name="lnpw_tipping_button_image_background"><img
            ...
            <input type="hidden" class="widget-tipping-basic-background_id_wide"
            ...
            <?php else : ?>
            <button id="lnpw_tipping_button_image_background_banner_wide"
                class="widget-tipping-basic-upload_box_image_wide"
    ...
    <div class="row">
        ...
        <div class="col-50">
            <input id="<?php echo esc_attr($this->get_field_id('background_color')); ?>"
                class="widget-tipping-basic-background_color_wide"
    ...
    <div class="row">
        ...
        <input id="<?php echo esc_attr($this->get_field_id('hf_color')); ?>" class="widget-tipping-basic-hf_color_wide"
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($logo_id) : ?>
            <button id="lnpw_tipping_button_logo_banner_wide" class="widget-tipping-basic-upload_box_logo_wide"
                name="lnpw_tipping_button_image"><img width="100" height="100" alt="Tipping box logo"
                    src="<?php echo $logo[0]; ?>" /></a></button>
            <button
                class="widget-tipping-basic-remove_box_image_wide"><?php echo esc_html__('Remove', 'text_domain'); ?></button>
            <input type="hidden" class="widget-tipping-basic-logo_id_wide"
    ...
    <div class="row">
        ...
        <div class="col-50">
            ...
            <input id="<?php echo esc_attr($this->get_field_id('title_text_color')); ?>"
                ...
                class="widget-tipping-basic-title_text_color_wide" type="text"
    ...
    <div class="row">
        ...
        <div class="col-50">
            ...
            <input id="<?php echo esc_attr($this->get_field_id('description_color')); ?>"
                ...
                class="widget-tipping-basic-description-color_wide" type="text"
    ...
    <div class="row">
        ...
        <div class="col-50">
            ...
            <input id="<?php echo esc_attr($this->get_field_id('tipping_text_color')); ?>"
                ...
                class="widget-tipping-basic-tipping-color_wide" value="<?php echo esc_attr($tipping_text_color); ?>" />
        </div>
    </div>
    <div class="row">
        <div class="col-50">
    ...
    <div class="row">
        <div class="col-50">
            ...
            <input id="<?php echo esc_attr($this->get_field_id('fixed_background')); ?>"
                ...
                class="widget-tipping-basic-fixed_background_wide" value="<?php echo esc_attr($fixed_background); ?>" />
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-50">
            <input id="<?php echo esc_attr($this->get_field_id('button_text_color')); ?>"
                class="widget-tipping-basic-button_text_color_wide"
    ...
    <div class="row">
        ...
        <input id="<?php echo esc_attr($this->get_field_id('button_color')); ?>"
            class="widget-tipping-basic-button_color_wide"
