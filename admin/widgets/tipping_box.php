            ...
            <fieldset>
                ...
                <div class="btcpw_tipping_box_amount">
                    ...
                    <div class="btcpw_tipping_free_input btcpw_widget">
                        <input type="number" id="btcpw_tipping_amount_btcpw_widget"
                            name="btcpw_tipping_amount_btcpw_widget" placeholder="0.00" required />


                        <select required name="btcpw_tipping_currency_btcpw_widget"
                            id="btcpw_tipping_currency_btcpw_widget">
                    ...
                    <div class="btcpw_tipping_converted_values">
                        <input type="text" id="btcpw_converted_amount_btcpw_widget" name="btcpw_converted_amount"
                            readonly />
                        <input type="text" id="btcpw_converted_currency_btcpw_widget" name="btcpw_converted_currency"
                            readonly />
                    </div>
                </div>
                ...
                <div id="button">
                    ...
                    <button type="submit"
                        id="btcpw_tipping__button_btcpw_widget"><?php echo (!empty($instance['button_text']) ? ($instance['button_text']) : 'Tip'); ?></button>
                </div>
            </fieldset>
...
<div class="tipping_box">
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($background) : ?>
            <button class="widget-tipping-basic-upload_box_image" name="lnpw_tipping_button_image_background"><img
            ...
            <?php else : ?>
            <button class="widget-tipping-basic-upload_box_image"
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($logo_id) : ?>
            <button class="widget-tipping-basic-upload_box_logo" name="lnpw_tipping_button_image"><img
                    alt="Tipping box logo" src="<?php echo $logo[0]; ?>" /></a></button>
            <button
            ...
            <?php else : ?>
            <button class="widget-tipping-basic-upload_box_logo"
