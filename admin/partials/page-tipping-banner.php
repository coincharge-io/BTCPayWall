    ...
    <form method="POST" action="options.php">
        ...
        <div class="container_predefined_amount">
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" class="btcpw_fixed_amount_enable" name="btcpw_tipping_banner_fixed_amount[value1][enabled]" <?php checked(isset($fixed_amount['value1']['enabled'])); ?> value="true" />
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" class="btcpw_fixed_amount_enable" name="btcpw_tipping_banner_fixed_amount[value2][enabled]" <?php echo checked(isset($fixed_amount['value2']['enabled'])); ?> value="true" />
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" class="btcpw_fixed_amount_enable" name="btcpw_tipping_banner_fixed_amount[value3][enabled]" <?php checked(isset($fixed_amount['value3']['enabled'])); ?> value="true" />
