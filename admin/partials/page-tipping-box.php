...
$used_currency = get_option('btcpw_tipping_box_currency');
$used_dimension = get_option('btcpw_tipping_box_dimension');
$redirect = get_option('btcpw_tipping_box_redirect');
$text = get_option('btcpw_tipping_box_text');
$color = get_option('btcpw_tipping_box_color');
...
<div class="tipping_box_settings">
    <form method="POST" action="options.php">
        <?php settings_fields('btcpw_tipping_box_settings'); ?>
        <div class="row">
            <div class="col-50">
