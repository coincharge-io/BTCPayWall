...
$color = array(
    ...
    'active' => $result[0]['active_color'] ?? '#808080',
    'inactive'  => $result[0]['inactive_color'] ?? '#D3D3D3',
);
$image = array(
    'logo' => $result[0]['logo'] ?? '',
    ...
    <form method="POST" action="" id="tipping_page_add_form">
        ...
        <div class="container_predefined_amount">
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" id="btcpw_page_value_1_enabled" class="btcpw_fixed_amount_enable" name="btcpw_tipping_page_fixed_amount[value1][enabled]" <?php checked(isset($fixed_amount['value1']['enabled'])); ?> value="true" />
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" id="btcpw_page_value_2_enabled" class="btcpw_fixed_amount_enable" name="btcpw_tipping_page_fixed_amount[value2][enabled]" <?php checked(isset($fixed_amount['value2']['enabled'])); ?> value="true" />
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <input type="checkbox" id="btcpw_page_value_3_enabled" class="btcpw_fixed_amount_enable" name="btcpw_tipping_page_fixed_amount[value3][enabled]" <?php checked(isset($fixed_amount['value3']['enabled'])); ?> value="true" />
