    ...
    <form method="POST" action="" id="tipping_banner_high_add_form">
        ...
        <div class="row">
            <div class="col-50">
                ...
                <input type="checkbox" id="btcpw_tipping_banner_high_show_icon" class="btcpw_tipping_banner_high_show_icon" name="btcpw_tipping_banner_high_show_icon" value="true" />
            </div>
        </div>
        <div class="container_predefined_amount">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-50">
                    ...
                    <input type="text" id="btcpw_tipping_banner_high_high_icon2" class="btcpw_tipping_banner_high_icon2" name="btcpw_tipping_banner_high_fixed_amount[value2][icon]" placeholder="Font Awesome Icon" title="Font Awesome Icon class" value="<?php echo $fixed_amount['value2']['icon']; ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-50">
                ...
                <div class="col-50">
                    <input type="checkbox" id="btcpw_banner_high_value_3_enabled" class="btcpw_fixed_amount_enable" name="btcpw_tipping_banner_high_fixed_amount[value3][enabled]" <?php checked(isset($fixed_amount['value3']['enabled'])); ?> value="true" />
