...
<div id="btcpw_pay_per_view_paywall">
    <div>
        <form method="POST" action="options.php">
            ...
            <div class="row">
                <div class="col-20">
                    <label for="btcpw_pay_per_view_info_color">Price info color</label>
                </div>
                <div class="col-80">
    ...
    <div id="btcpw_pay_per_view_paywall_preview">
        <div class="btcpw_pay_preview pay_per_view">
            ...
            <div class="btcpw_pay__footer_preview pay_per_view">
                <div>
                    <button disabled type="button" id="btcpw_pay__button_preview_pay_per_view" data-post_id="<?php echo get_the_ID(); ?>">Pay</button>
                </div>
