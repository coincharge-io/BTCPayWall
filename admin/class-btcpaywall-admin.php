...
class BTCPayWall_Admin
{
	...
	public function register_settings()
	{
		...
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_fixed_amount', array(
		...
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_text', array(
			'type' => 'array', 'default' => array(
		...
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_currency', array('type' => 'string', 'default' => 'SATS'));
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_color', array(
			'type' => 'array', 'default' => array(
				'button_text' => '#FFFFFF',
				'background' => '#E6E6E6',
				'button' => '#FE642E',
		...
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_image', array(
			'type' => 'array', 'default' => array(
		...
		register_setting('btcpw_tipping_banner_settings', 'btcpw_tipping_banner_enter_amount', array('type' => 'string', 'default' => 'false', 'sanitize_callback' => array($this, 'sanitize_mandatory')));

		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_dimension', array('type' => 'string', 'default' => '250x300', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_redirect', array('type' => 'string', 'default' => get_site_url()));

		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_collect', array('type' => 'array', 'default' => array(
			'name' => array(
				'collect' => 'false',
				'mandatory' => 'false'
			),
		...
		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_text', array(
			'type' => 'array', 'default' => array(
				'title' => 'Support my work',
				'description' => '',
				'info' => 'Enter Tipping Amount',
		...
		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_currency', array('type' => 'string', 'default' => 'SATS'));
		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_color', array(
			'type' => 'array', 'default' => array(
				'button_text' => '#FFFFFF',
				'background' => '#E6E6E6',
				'hf_background' => '#1d5aa3',
		...
		register_setting('btcpw_tipping_box_settings', 'btcpw_tipping_box_image', array(
			'type' => 'array', 'default' => array(
				'logo' => 'https://btcpaywall.com/wp-content/uploads/2021/07/BTCPayWall-logo_square.jpg',
				'background' => '',
			), 'sanitize_callback' => array($this, 'validate_images')
		...
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_dimension', array('type' => 'string', 'default' => '250x300', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_redirect', array('type' => 'string', 'default' => get_site_url()));

		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_collect', array('type' => 'array', 'default' => array(
			'name' => array(
				'collect' => 'false',
				'mandatory' => 'false'
			),
		...
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_fixed_amount', array(
			'type' => 'array', 'default' => array(
				'value1' => array(
					'enabled' => 'true',
					'currency' => 'SATS',
		...
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_text', array(
			'type' => 'array', 'default' => array(
				'title' => 'Support my work',
				'info' => 'Enter Tipping Amount',
				'button' => 'Tipping now',
				'step1'	 => 'Pledge',
				'step2'	=> 'Info'
			), 'sanitize_callback' => array($this, 'validate_page_textarea')
		));

		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_currency', array('type' => 'string', 'default' => 'SATS'));
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_color', array(
			'type' => 'array', 'default' => array(
				'button_text' => '#FFFFFF',
				'background' => '#E6E6E6',
				'button' => '#FE642E',
				...
				'active' => '#808080',
				'inactive'	=> '#D3D3D3'
			), 'sanitize_callback' => array($this, 'validate_page_colors')
		));
		register_setting('btcpw_tipping_page_settings', 'btcpw_tipping_page_image', array(
			'type' => 'array', 'default' => array(
				'logo' => 'https://btcpaywall.com/wp-content/uploads/2021/07/BTCPayWall-logo_square.jpg',
				'background' => '',
			), 'sanitize_callback' => array($this, 'validate_images')
