...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/src/js/btc-paywall-design-preview-admin.js");
/******/ })
/************************************************************************/
/******/ ({
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.btcpw_pay_per_post_button_color, .btcpaywall_pay_per_post_button_color').iris({
      defaultColor: true,
    ...
    $('.btcpw_pay_per_post_background, .btcpaywall_pay_per_post_background').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay_preview.pay_per_post').css('backgroundColor', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_post_header_color, .btcpaywall_pay_per_post_title_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__content_preview.pay_per_post h2').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_post_info_color, .btcpaywall_pay_per_post_info_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__content_preview.pay_per_post p').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_post_button_text_color, .btcpaywall_pay_per_post_button_text_color').iris({
      defaultColor: true,
      change: function (event, ui) {
    ...
    $('#btcpw_pay_per_post_title, #btcpaywall_pay_per_post_title').on('input', function () {
      $('.btcpw_pay__content_preview.pay_per_post h2, .btcpaywall_pay__content_preview.pay_per_post h2').text($(this).val());
    });
    $('#btcpw_pay_per_post_width, #btcpaywall_pay_per_post_width').on('input, change', function () {
      $('.btcpw_pay_preview.pay_per_post, .btcpaywall_pay_preview.pay_per_post').css('width', $(this).val() + 'px');
    });
    ...
    $('#btcpw_pay_per_post_show_additional_help_link, #btcpaywall_pay_per_post_show_additional_help_link').change(function () {
      $('.btcpw_additional_help_preview.pay_per_post, .btcpaywall_additional_help_preview.pay_per_post').toggle();
    });
    $('#btcpw_pay_per_post_additional_help_link_text, #btcpaywall_pay_per_post_additional_help_link_text').on('input', function () {
      $('.btcpw_additional_help_preview.pay_per_post a, .btcpaywall_additional_help_preview.pay_per_post a').text($(this).val());
    });
    $('#btcpw_pay_per_post_additional_help_link, #btcpaywall_pay_per_post_additional_help_link').on('input', function () {
      $('.btcpw_help__additional_link_preview.pay_per_post, .btcpaywall_help__additional_link_preview.pay_per_post').attr('href', $(this).val());
    });
    ...
    $('.btcpw_pay_per_post_price_placeholder, .btcpw_pay_per_post_currency_placeholder, .btcpw_pay_per_post_duration_placeholder, .btcpw_pay_per_post_duration_type_placeholder, .btcpaywall_pay_per_post_price_placeholder, .btcpaywall_pay_per_post_currency_placeholder, .btcpaywall_pay_per_post_duration_placeholder, .btcpaywall_pay_per_post_duration_type_placeholder').click(function () {
      ...
      $('#btcpw_pay_per_post_info, #btcpaywall_pay_per_post_info').val(function () {
        $(this).focus();
    ...
    $('#btcpw_pay_per_view_show_help_link, #btcpaywall_pay_per_view_show_help_link').change(function () {
      $('.btcpw_help_preview.pay_per_view, .btcpaywall_help_preview.pay_per_view').toggle();
    });
    $('#btcpw_pay_per_view_help_link_text, #btcpaywall_pay_per_view_help_link_text').on('input', function () {
      $('.btcpw_help_preview.pay_per_view a,.btcpaywall_help_preview.pay_per_view a').text($(this).val());
    });
    $('#btcpw_pay_per_view_help_link, #btcpaywall_pay_per_view_help_link').on('input', function () {
      $('.btcpw_help__link_preview.pay_per_view, .btcpaywall_help__link_preview.pay_per_view').attr('href', $(this).val());
    });
    $('#btcpw_pay_per_view_show_additional_help_link, #btcpaywall_pay_per_view_show_additional_help_link').change(function () {
      $('.btcpw_additional_help_preview.pay_per_view, .btcpaywall_additional_help_preview.pay_per_view').toggle();
    });
    $('#btcpw_pay_per_view_additional_help_link_text, #btcpaywall_pay_per_view_additional_help_link_text').on('input', function () {
      $('.btcpw_additional_help_preview.pay_per_view a, .btcpaywall_additional_help_preview.pay_per_view a').text($(this).val());
    });
    $('#btcpw_pay_per_view_additional_help_link, #btcpaywall_pay_per_view_additional_help_link').on('input', function () {
      $('.btcpw_additional_help__link_preview.pay_per_view, .btcpaywall_additional_help__link_preview.pay_per_view').attr('href', $(this).val());
    });
    $('#btcpw_pay_per_view_title, #btcpaywall_pay_per_view_title').on('input', function () {
    ...
    $('#btcpw_pay_per_view_width, #btcpaywall_pay_per_view_width').on('input, change', function () {
      $('.btcpw_pay_preview.pay_per_view, .btcpaywall_pay_preview.pay_per_view').css('width', $(this).val() + 'px');
    });
    $('#btcpw_pay_per_view_height, #btcpaywall_pay_per_view_height').on('input, change', function () {
      $('.btcpw_pay_preview.pay_per_view, .btcpaywall_pay_preview.pay_per_view').css('height', $(this).val() + 'px');
    });
    $('.btcpw_pay_per_view_price_placeholder, .btcpw_pay_per_view_currency_placeholder, .btcpw_pay_per_view_duration_placeholder, .btcpw_pay_per_view_duration_type_placeholder, .btcpaywall_pay_per_view_price_placeholder, .btcpaywall_pay_per_view_currency_placeholder, .btcpaywall_pay_per_view_duration_placeholder, .btcpaywall_pay_per_view_duration_type_placeholder').click(function () {
      var buttonValue = $(this).val();
    ...
    $('.btcpw_pay_per_view_button_color, #btcpaywall_pay_per_view_button_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('#btcpw_pay__button_preview_pay_per_view, #btcpaywall_pay__button_preview_pay_per_view').css('backgroundColor', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    ...
    $('.btcpw_pay_per_view_button_color_hover, #btcpaywall_pay_per_view_button_color_hover').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('#btcpw_pay__button_preview:hover').css('backgroundColor', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    ...
    $('.btcpw_pay_per_view_background, #btcpaywall_pay_per_view_background').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay_preview.pay_per_view, .btcpaywall_pay_preview.pay_per_view').css('backgroundColor', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    ...
    $('#btcpaywall_pay_per_view_preview_title').on('input', function () {
      $('.btcpw_pay__preview_preview.preview_description h3').text($(this).val());
    });
    $('#btcpaywall_pay_per_view_preview_description').on('change input', function () {
      $('.btcpw_pay__preview_preview.preview_description p').text($(this).val());
    });
    $('.btcpw_pay_per_view_header_color, #btcpaywall_pay_per_view_preview_title_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__content_preview.pay_per_view h2, .btcpaywall_pay__content_preview.pay_per_view h2').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_view_info_color, #btcpaywall_pay_per_view_info_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__content_preview.pay_per_view p, .btcpaywall_pay__content_preview.pay_per_view p').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_view_button_text_color, #btcpaywall_pay_per_view_button_text_color').iris({
      defaultColor: true,
      change: function (event, ui) {
    ...
    $('.btcpaywall_pay_per_view_title_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__content_preview.pay_per_view h2').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    ...
    $('.btcpw_pay_per_view_preview_title_color, #btcpaywall_pay_per_view_preview_title_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__preview_preview.pay_per_view h2, .btcpw_pay__preview_preview.preview_description h3').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    });
    $('.btcpw_pay_per_view_preview_description_color, #btcpaywall_pay_per_view_preview_description_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay__preview_preview.pay_per_view p, .btcpw_pay__preview_preview.preview_description p').css('color', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
    ...
    $('.btcpw_pay_per_file_button_color').iris({
      defaultColor: true,
      change: function (event, ui) {
        $('.btcpw_pay_preview.content_store button').css('backgroundColor', ui.color.toString());
      },
      clear: function () {},
      hide: true,
      palettes: true
...
/******/ });
//# sourceMappingURL=btc_paywall_design_preview_admin.js.map