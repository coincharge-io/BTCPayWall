...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/src/js/lnbits.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/src/js/lnbits.js":
/*!*********************************!*\
  !*** ./assets/src/js/lnbits.js ***!
  \*********************************/
...
(function ($) {
  ...
  function showQR(target, request) {
    target.append(`<div id=lnbits_modal style="padding:20px; margin: 0 auto;"><div class=btcpaywall-qr-code></div></div>`);
    $(".btcpaywall-qr-code").qrcode({
      width: 450,
      height: 450,
      text: request
    });
    let dialog = $("#lnbits_modal").dialog({
      ...
      buttons: {
        "Copy invoice": function () {
          navigator.clipboard.writeText(request).then(() => $(".ui-dialog-buttonset button:first-child").text("Copied to clipboard").css({
  ...
  $(document).ready(function () {
    ...
    $("#btcpw_digital_download_form").submit(function (e) {
      ...
      if (payment_request && btcpw_invoice_id && form_container) {
        btcpwShowLNBitsFileInvoice(payment_request, btcpw_invoice_id, form_container);
        return;
      }
    ...
    $("#view_revenue_type, #post_revenue_type").submit(function (e) {
      ...
      if (payment_request && btcpw_invoice_id && form_container) {
        btcpwShowLNBitsInvoice(payment_request, btcpw_invoice_id, form_container);
        return;
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(payment_request, btcpw_invoice_id, form_container, $("#btcpw_redirect_link").val());
          }
        },
        error: function (error) {
          console.error(error);
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(payment_request, btcpw_invoice_id, form_container, $("#btcpw_redirect_link_btcpw_widget").val());
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(payment_request, btcpw_invoice_id, form_container, $("#btcpw_page_redirect_link").val());
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(btcpw_invoice_id, form_container, $("#btcpw_skyscraper_redirect_link_high").val());
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(btcpw_invoice_id, form_container, $("#btcpw_widget_btcpw_skyscraper_redirect_link_high").val());
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(payment_request, btcpw_invoice_id, form_container, $("#btcpw_skyscraper_redirect_link_wide").val());
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success) {
            ...
            btcpwShowTippingLNBitsInvoice(payment_request, btcpw_invoice_id, form_container, $("#btcpw_widget_btcpw_skyscraper_redirect_link_wide").val());
  ...
  function btcpwShowLNBitsInvoice(request, invoice_id, form_container) {
    let redirectTo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    setInterval(() => {
      btcpaywall_monitor_invoice(invoice_id).done(function (response) {
        if (response.data.status === "paid") {
          $.ajax({
  ...
  function btcpwShowTippingLNBitsInvoice(request, invoice_id, form_container) {
    let redirectTo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    setInterval(() => {
      btcpaywall_monitor_invoice(invoice_id).done(function (response) {
        if (response.data.status === "paid") {
