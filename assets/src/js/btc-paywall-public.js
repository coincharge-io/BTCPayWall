(function ($) {
  ...
  $ (document).ready (function () {
    $ (
      'input[type=radio][name=btcpw_tipping_default_amount]'
    ).change (function () {
  ...
  $ (document).ready (function () {
    ...
    $ (
      'input[type=radio][name=btcpw_page_tipping_default_amount]'
    ).change (function () {
  ...
  $ (document).ready (function () {
    ...
    var validationField = fixedAmount.length !== 0 && freeInput.length === 0
      ? fixedAmount
      : freeInput;
