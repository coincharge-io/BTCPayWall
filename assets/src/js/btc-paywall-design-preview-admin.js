...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('#btcpw_pay_per_post_additional_help_link, #btcpaywall_pay_per_post_additional_help_link').on('input', function () {
      $('.btcpw_help__additional_link_preview.pay_per_post, .btcpaywall_help__additional_link_preview.pay_per_post').attr(
        'href',
        $(this).val()
      )
    })
    ...
    $('#btcpw_pay_per_view_additional_help_link, #btcpaywall_pay_per_view_additional_help_link').on('input', function () {
      $('.btcpw_additional_help__link_preview.pay_per_view, .btcpaywall_additional_help__link_preview.pay_per_view').attr(
        'href',
        $(this).val()
      )
    })
