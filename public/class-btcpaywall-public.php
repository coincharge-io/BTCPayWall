...
<div class="btcpw_pay">
    ...
    <div class="btcpw_pay__footer">
        <div>
            <button type="button" id="btcpw_pay__button"
                data-post_id="<?php echo get_the_ID(); ?>"><?php echo BTCPayWall_Public::get_payblock_button_string() ?></button>
        </div>
        <div class="btcpw_pay__loading">
            <p class="loading"></p>
        </div>
        <div class="btcpw_help">
            <a class="btcpw_help__link" href="https://lightning-paywall.coincharge.io/how-to-pay-the-lightning-paywall/"
...
<div class="btcpw_pay">
    ...
    <div class="btcpw_pay__footer">
        ...
        <div class="btcpw_help">
            <a class="btcpw_help__link" href="https://btcpaywall.com/how-to-pay-the-bitcoin-paywall/"
                target="_blank">Help</a>
        </div>
    </div>
</div>
            ...
            <fieldset>
                ...
                <div class="btcpw_tipping_box_amount">
                    ...
                    <div class="<?php echo "btcpw_tipping_free_input {$is_widget}"; ?>">
                        <input type="number" id="btcpw_tipping_amount" name="btcpw_tipping_amount" placeholder="0.00"
                            required />
                ...
                <input type="hidden" id="btcpw_redirect_link" name="btcpw_redirect_link"
                    value=<?php echo $atts['redirect']; ?> />
                <div id="button">

                    <button type="submit"
                        id="btcpw_tipping__button"><?php echo (!empty($atts['button_text']) ? esc_html($atts['button_text']) : 'Tip'); ?></button>
                </div>
            </fieldset>
...
<div id="btcpw_page">
    <div class="<?php echo ltrim("btcpw_skyscraper_banner {$is_wide}"); ?>">
        ...
        <div class=" <?php echo trim("btcpw_skyscraper_tipping_container {$container_suffix}"); ?>">
            <form method="POST" action="" id="<?php echo "skyscraper_tipping_form{$form_suffix}"; ?>">
                <fieldset>
                    ...
                    <div class="<?php echo trim("btcpw_skyscraper_amount {$is_wide}"); ?>">
                        ...
                        <div class="<?php echo trim('btcpw_skyscraper_amount_' . $key . ' ' . $is_wide); ?>">
                            <div>
                                <input type="radio"
                                    class="<?php echo trim("btcpw_skyscraper_tipping_default_amount {$is_wide}"); ?>"
                                    id="<?php echo $key . '_' . $is_wide; ?>"
                                    name="<?php echo "btcpw_skyscraper_tipping_default_amount_{$is_wide}"; ?>"
                        ...
                        <div class="<?php echo trim("btcpw_skyscraper_tipping_free_input {$is_wide}"); ?>">
                            <input type="number" id="<?php echo "btcpw_skyscraper_tipping_amount{$form_suffix}"; ?>"
                                name="<?php echo "btcpw_skyscraper_tipping_amount_{$is_wide}"; ?>" placeholder="0.00"
                                required />


                            <select required name="<?php echo "btcpw_skyscraper_tipping_currency_{$is_wide}"; ?>"
                                id="<?php echo "btcpw_skyscraper_tipping_currency{$form_suffix}"; ?>">
                                <option disabled value="">Select currency</option>
                                <?php foreach ($supported_currencies as $currency) : ?>
                                <option <?php echo $atts['currency'] === $currency ? 'selected' : ''; ?>
                                    value="<?php echo $currency; ?>">
                    ...
                    <div class="<?php echo trim("btcpw_skyscraper_tipping_converted_values {$is_wide}"); ?>">
                        <input type="text" id="<?php echo "btcpw_skyscraper_converted_amount{$form_suffix}"; ?>"
                            name="<?php echo "btcpw_skyscraper_converted_amount_{$is_wide}"; ?>" readonly />
                        <input type="text" id="<?php echo "btcpw_skyscraper_converted_currency{$form_suffix}"; ?>"
                            name="<?php echo "btcpw_skyscraper_converted_currency_{$is_wide}"; ?>" readonly />
                    </div>


                    <div class="<?php echo "btcpw_skyscraper_button {$is_wide}"; ?>"
                        ...
                        <div>
                            <button type="submit"
                                id="<?php echo "btcpw_skyscraper_tipping__button{$form_suffix}"; ?>"><?php echo (!empty($atts['button_text']) ? esc_html($atts['button_text']) : 'Tip'); ?></button>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <fieldset>
                    <div class="<?php echo ltrim("btcpw_skyscraper_donor_information {$is_wide}"); ?>">
                        ...
                        <div
                            class="<?php echo "btcpw_skyscraper_tipping_donor_{$collect[$key]['label']}_wrap {$is_wide}"; ?>">

                            <input type="text" placeholder="<?php echo $collect[$key]['label']; ?>"
                                id="<?php echo "btcpw_skyscraper_tipping_donor_{$collect[$key]['id']}_{$is_wide}"; ?>"
                                name="<?php echo "btcpw_skyscraper_tipping_donor_{$collect[$key]['label']}_{$is_wide}"; ?>"
            ...
            <fieldset>
                ...
                <div class="btcpw_page_amount">
                    ...
                    <div class="<?php echo 'btcpw_page_amount_' . $key; ?>">
                        <div>
                            <input type="radio" class="btcpw_page_tipping_default_amount"
                                id="<?php echo "{$key}_page"; ?>" name="btcpw_page_tipping_default_amount"
                                <?php echo $key == $index ? 'required' : ''; ?>
                    ...
                    <div class="btcpw_page_tipping_free_input">
                        <input type="number" id="btcpw_page_tipping_amount" name="btcpw_page_tipping_amount"
                ...
                <div class="btcpw_page_tipping_converted_values">
                    ...
                    <input type="text" id="btcpw_page_converted_currency" name="btcpw_page_converted_currency"
                        readonly />
                </div>


                <div id="btcpw_page_button">
                    <input type="hidden" id="btcpw_page_redirect_link" name="btcpw_page_redirect_link"
                        value=<?php echo $atts['redirect']; ?> />
                    <?php if ($collect_data == 'true') : ?>
                    <input type="button" name="next" class="page-next-form" value="continue >" />
                    <?php else : ?>
                    <button type="submit"
                        id="btcpw_page_tipping__button"><?php echo (!empty($atts['button_text']) ? esc_html($atts['button_text']) : 'Tip'); ?></button>
                    <?php endif; ?>
                </div>
                ...
                <div class="btcpw_page_donor_information">
                    ...
                    <div class="<?php echo "btcpw_page_tipping_donor_{$collect[$key]['id']}_wrap"; ?>">
                        ...
                        <input type="text" placeholder="<?php echo esc_html($collect[$key]['label']); ?>"
                            id="<?php echo "btcpw_page_tipping_donor_{$collect[$key]['id']}"; ?>"
                            name="<?php echo "btcpw_page_tipping_donor_{$collect[$key]['label']}"; ?>"
                            <?php echo $collect[$key]['mandatory'] === 'true' ? 'required' : ''; ?> />
                    </div>
                    <?php endif; ?>
                    <?php endforeach; ?>
