...
class Post_Template
{
    ...
    {
        add_meta_box(
            "btcpaywall_{$this->type}_template",
            __('Post Template', 'btcpaywall'),
            [$this, 'html'],
            "btcpw_{$this->type}_template",
            'normal',
            'high'
        );
    }
    ...
    public function save(int $post_id)
    {
        ...
        if (!isset($_POST["btcpaywall_{$this->type}_template_nonce"]) || !wp_verify_nonce(sanitize_text_field($_POST["btcpaywall_{$this->type}_nonce"]), basename(__FILE__))) {
            return;
        }
    ...
    {
        $fields = [
            ["name" => "btcpaywall_{$this->type}_text_template_name"],
            [
                "name" => "btcpaywall_{$this->type}_text_dimension",
                "std" => "250x300"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_background",
                "std" => ""
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_background",
                "std" => "#E6E6E6"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_header_footer_background",
                "std" => "#1d5aa3"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_logo"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_title",
                "std" => "Support my work"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_title",
                "std" => "#ffffff"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_description",
                "std" => ""
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_description",
                "std" => "#000000"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_main",
                "std" => "Enter Tipping Amount"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_main",
                "std" => "#000000"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_amounts",
                "std" => "#ffa500"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_selected_amount",
                "std" => "#000"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_button",
                "std" => "Tipping now"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_button_text",
                "std" => "#FFFFFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_button",
                "std" => "#FE642E"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_button_hover",
                "std" => "#FFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_continue_button",
                "std" => "Continue"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_continue_button_text",
                "std" => "#FFFFFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_continue_button",
                "std" => "#FE642E"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_continue_button_hover",
                "std" => "#FFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_previous_button",
                "std" => "Previous"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_previous_button_text",
                "std" => "#FFFFFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_previous_button",
                "std" => "#1d5aa3"
            ],
            [
                "name" => "btcpaywall_{$this->type}_color_previous_button_hover",
                "std" => "#FFF"
            ],
            [
                "name" => "btcpaywall_{$this->type}_text_currency",
                "std" => "SATS"
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_free_input",
                "std" => true
            ],
            ["name" => "btcpaywall_{$this->type}_text_thankyou"],
            [
                "name" => "btcpaywall_{$this->type}_bool_show_icons",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_display_name",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_mandatory_name",
                "std" => false
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_display_email",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_mandatory_email",
                "std" => false
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_display_address",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_mandatory_address",
                "std" => false
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_display_phone",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_mandatory_phone",
                "std" => false
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_display_message",
                "std" => true
            ],
            [
                "name" => "btcpaywall_{$this->type}_bool_mandatory_message",
                "std" => false
            ]
        ];
        return $fields;
    ...
    {
        if ("btcpw_{$this->type}" !== get_post_type()) {
            return false;
        }
        global $post;

        if ('btcpw_donation' === $post->post_type) {
            $template = get_post_meta($post->ID, "btcpaywall_{$this->type}_text_template_name", true);
    ...
    {
        wp_nonce_field(basename(__FILE__), "btcpaywall_{$this->type}_nonce");
        $stored_data = get_post_meta($post->ID);
        $template = $stored_data["btcpaywall_{$this->type}_text_template_name"][0];
        ...
        $logo = wp_get_attachment_image_src($stored_data["btcpaywall_{$this->type}_text_logo"][0]);
        $background = wp_get_attachment_image_src($stored_data["btcpaywall_{$this->type}_text_background"][0]);
?>
        <style>
