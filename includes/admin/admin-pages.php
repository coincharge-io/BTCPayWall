...
function btcpaywall_add_menu_pages()
{
    ...
    add_submenu_page('btcpw_general_settings', esc_html__('Download -> All Products', 'btcpaywall'), esc_html__('Download Store -> All Products', 'btcpaywall'), 'manage_options', 'edit.php?post_type=digital_download');
    add_submenu_page('btcpw_general_settings', esc_html__('Download -> Add Product', 'btcpaywall'), esc_html__('Download Store -> Add Product', 'btcpaywall'), 'manage_options', 'post-new.php?post_type=digital_download');
