...
class Elementor_BTCPW_Start_Video_Widget extends \Elementor\Widget_Base
{
	...
	protected function render()
	{
		...
		if ($enable_pay_view_block) {
			echo do_shortcode("[btcpw_start_video pay_view_block='true' title='{$title}' description='{$description}' preview='{$preview}' currency='{$currency}' btc_format='{$btc_format}' duration='{$duration}' duration_type='{$duration_type}' price='{$price}']");
		}
	}
}
