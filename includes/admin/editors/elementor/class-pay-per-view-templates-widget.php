...
class BTCPayWall_Elementor_Pay_Per_View_Template_Widget extends \Elementor\Widget_Base
{
  /**
   * @return string
   */
  ...
  {
    return 'btcpaywall_pay_per_view_templates';
  }
  ...
  {
    return 'BTCPayWall Pay Per View Templates';
  }
