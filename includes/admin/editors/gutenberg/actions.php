...
function load_gutenberg()
{
    ...
    register_block_type(
        ...
        [
            ...
            'render_callback' => (array('render_gutenberg')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_end_gutenberg')),
        ]
    );
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_start_video_gutenberg')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_shortcodes_gutenberg')),
        ]
    );
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_file_gutenberg')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_tipping_box')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_tipping_banner_wide')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_tipping_banner_high')),
            'attributes' => array(
                'className' => array(
                    'type' => 'string',
                    'default' => '',
    ...
    register_block_type(
        ...
        [
            'editor_script' => 'gutenberg-block-script',
            'render_callback' => (array('render_tipping_pages')),
            'attributes' => array(
                'className' => array(
                    'default' => '',
                    'type' => 'string'
