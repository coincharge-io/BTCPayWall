 ...
 */
	...
	/* public function register_settings()
	{
		...
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_currency', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_btc_format', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_price', array('type' => 'number', 'default' => 1000, 'sanitize_callback' => array($this, 'sanitize_number')));
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_duration', array('type' => 'integer', 'default' => '', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_duration_type', array('type' => 'string', 'default' => 'unlimited', 'sanitize_callback' => array($this, 'sanitize_text')));
		...
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_width', array('type' => 'string', 'default' => '300', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_post_paywall_options', 'btcpw_pay_per_post_height', array('type' => 'string', 'default' => '300', 'sanitize_callback' => array($this, 'sanitize_text')));





		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_currency', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_btc_format', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_price', array('type' => 'number', 'default' => 1000, 'sanitize_callback' => array($this, 'sanitize_number')));
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_duration', array('type' => 'integer', 'default' => '', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_duration_type', array('type' => 'string', 'default' => 'unlimited', 'sanitize_callback' => array($this, 'sanitize_text')));
		...
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_width', array('type' => 'string', 'default' => '350', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_view_paywall_options', 'btcpw_pay_per_view_height', array('type' => 'string', 'default' => '550', 'sanitize_callback' => array($this, 'sanitize_text')));



		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_currency', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_btc_format', array('type' => 'string', 'default' => 'SATS', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_price', array('type' => 'number', 'default' => 1000, 'sanitize_callback' => array($this, 'sanitize_number')));
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_duration', array('type' => 'integer', 'default' => '', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_duration_type', array('type' => 'string', 'default' => 'unlimited', 'sanitize_callback' => array($this, 'sanitize_text')));
		...
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_width', array('type' => 'string', 'default' => '350', 'sanitize_callback' => array($this, 'sanitize_text')));
		register_setting('btcpw_pay_per_file_paywall_options', 'btcpw_pay_per_file_height', array('type' => 'string', 'default' => '550', 'sanitize_callback' => array($this, 'sanitize_text')));
	} */
