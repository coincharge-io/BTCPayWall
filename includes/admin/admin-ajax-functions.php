...
function btcpaywall_create_pay_per_shortcode()
{
    ...
    $row->create([
        ...
        'pay_block' => $_POST['pay_block'] ?? null,
        ...
        'preview_title' => $_POST['preview_title'] ?? null,
        'preview_title_color' => $_POST['preview_title_color'] ?? null,
        'preview_description' => $_POST['preview_description'] ?? null,
        'preview_description_color' => $_POST['preview_description_color'] ?? null,
        ...
        'additional_link' => $_POST['additional_link'] ?? null,
        ...
        'mandatory_name' => $_POST['mandatory_name'] ?? null,
        'display_email' => $_POST['display_email'] ?? null,
        'mandatory_email' => $_POST['mandatory_email'] ?? null,
        'display_phone' => $_POST['display_phone'] ?? null,
        'mandatory_phone' => $_POST['mandatory_phone'] ?? null,
        'display_address' => $_POST['display_address'] ?? null,
        'mandatory_address' => $_POST['mandatory_address'] ?? null,
        'display_message' => $_POST['display_message'] ?? null,
        'mandatory_message' => $_POST['mandatory_message'] ?? null,
    ]);
    if ($row) {
        wp_send_json_success(array('res' => true, 'data' => array('id' => $row->id)));
    } else {
