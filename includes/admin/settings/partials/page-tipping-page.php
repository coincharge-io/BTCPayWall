    ...
    <form method="POST" action="" id="tipping_page_add_form">
        <div class="row">
            ...
            <div class="col-50" id="btcpw_tipping_page_shortcode">
                <input id="btcpw_tipping_page_form_name" class="btcpw_tipping_page_form_name" name="btcpw_tipping_page_form_name" type="text" value="<?php echo esc_html($form_name); ?>">
            </div>
        </div>
        <?php if ($shortcode) : ?>
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-50">
                <?php if ($background) : ?>
                    <button id="btcpw_tipping_page_button_image_background" class="btcpw_tipping_page_button_image_background" name="btcpw_tipping_page_button_image_background"><img src="<?php echo esc_url($background[0]); ?>" height=100px width=100px /></a></button>
                    <button class="btcpw_tipping_page_button_remove_background">Remove image</button>
                    <input type="hidden" id="btcpw_tipping_page_image_background" class="btcpw_tipping_page_image_background" name="btcpw_tipping_page_image[background]" value=<?php echo esc_attr($image['background']); ?> />
                <?php else : ?>
        ...
        <div class="row">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_page_background" class="btcpw_tipping_page_background" name="btcpw_tipping_page_color[background]" type="text" value=<?php echo esc_attr($color['background']); ?> />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_hf_background" class="btcpw_tipping_hf_background" name="btcpw_tipping_page_color[hf_background]" type="text" value=<?php echo esc_attr($color['hf_background']); ?> />
            </div>
        </div>
        <h3>Description</h3>
        ...
        <div class="row">
            ...
            <div class="col-50">
                <?php if ($logo) : ?>
                    <button id="btcpw_tipping_page_button_image" class="btcpw_tipping_page_button_image" name="btcpw_tipping_page_button_image"><img src="<?php echo esc_url($logo[0]); ?>" height=100px width=100px /></a></button>
                    <button class="btcpw_tipping_page_button_remove">Remove image</button>
                    <input type="hidden" id="btcpw_tipping_page_image" class="btcpw_tipping_page_image" name="btcpw_tipping_page_image[logo]" value=<?php echo esc_attr($image['logo']); ?> />
                <?php else : ?>
        ...
        <div class="row">
            <div class="col-50">
                ...
                <textarea id="btcpw_tipping_page_title" name="btcpw_tipping_page_text[title]"><?php echo esc_html($text['title']); ?></textarea>
            </div>
            <div class="col-50">
                <label for="btcpw_tipping_page_title_color">Title text color</label>
                <input id="btcpw_tipping_page_title_color" class="btcpw_tipping_page_title_color" name="btcpw_tipping_page_color[title]" type="text" value=<?php echo esc_attr($color['title']); ?> />
            </div>
        </div>
        <div class="row">
            <div class="col-50">
                <label for="btcpw_tipping_page_text">Tipping text</label>
                <textarea id="btcpw_tipping_page_text" name="btcpw_tipping_page_text[info]"><?php echo esc_html($text['info']); ?></textarea>
            </div>
            <div class="col-50">
                <label for="btcpw_tipping_page_tipping_color">Tipping text color</label>
                <input id="btcpw_tipping_page_tipping_color" class="btcpw_tipping_page_tipping_color" name="btcpw_tipping_page_color[tipping]" type="text" value=<?php echo esc_attr($color['tipping']); ?> />
            </div>
        </div>
        <div class="row">
            <div class="col-50">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_page_redirect" name="btcpw_tipping_page_redirect" value=<?php echo esc_attr($redirect); ?> />
            </div>
        </div>
        <h3>Amount</h3>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_page_input_background" class="btcpw_tipping_page_input_background" name="btcpw_tipping_page_color[input_background]" type="text" value=<?php echo esc_attr($color['input_background']); ?> />
            </div>
        </div>
        <div class="row">
            <div class="col-50">
        ...
        <div class="container_predefined_amount">
            <div class="row">
                ...
                <div class="col-50">
                    ...
                    <input type="number" min=0 placeholder="Default Price1" step=1 name="btcpw_tipping_page_fixed_amount[value1][amount]" id="btcpw_default_page_price1" value="<?php echo esc_attr($fixed_amount['value1']['amount']); ?>">
            ...
            <div class="row">
                ...
                <div class="col-50">
                    ...
                    <input type="number" min=0 placeholder="Default Price2" step=1 name="btcpw_tipping_page_fixed_amount[value2][amount]" id="btcpw_default_page_price2" value="<?php echo esc_attr($fixed_amount['value2']['amount']); ?>">
            ...
            <div class="row">
                ...
                <div class="col-50">
                    ...
                    <input type="number" min=0 placeholder="Default Price3" step=1 name="btcpw_tipping_page_fixed_amount[value3][amount]" id="btcpw_default_page_price3" value="<?php echo esc_attr($fixed_amount['value3']['amount']); ?>">
        ...
        <div class="row">
            ...
            <div class="col-50">
                <input type="text" id="btcpw_tipping_page_button_text" name="btcpw_tipping_page_text[button]" value="<?php echo esc_attr($text['button']); ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-50">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_page_button_text_color" class="btcpw_tipping_page_button_text_color" name="btcpw_tipping_page_color[button_text]" type="text" value=<?php echo esc_attr($color['button_text']); ?> />
        ...
        <div class="row">
            ...
            <div class="col-50">
                <input id="btcpw_tipping_page_button_color" class="btcpw_tipping_page_button_color" name="btcpw_tipping_page_color[button]" type="text" value=<?php echo esc_attr($color['button']); ?> />
        ...
        <div class="row">
            <div class="col-50">
                ...
                <textarea id="btcpw_tipping_page_step1" name="btcpw_tipping_page_text[step1]"><?php echo esc_html($text['step1']); ?></textarea>
            </div>
            <div class="col-50">
                <label for="btcpw_tipping_page_tipping_color_active">Step 1 color</label>
                <input id="btcpw_tipping_page_tipping_color_active" class="btcpw_tipping_page_tipping_color_active" name="btcpw_tipping_page_color[active]" type="text" value=<?php echo esc_attr($color['active']); ?> />
            </div>
        </div>
        <div class="row">
            <div class="col-50">
                <label for="btcpw_tipping_page_step2">Step 2</label>
                <textarea id="btcpw_tipping_page_step2" name="btcpw_tipping_page_text[step2]"><?php echo esc_html($text['step2']); ?></textarea>
            </div>
            <div class="col-50">
