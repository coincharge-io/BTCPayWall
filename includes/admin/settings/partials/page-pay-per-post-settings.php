        ...
        <form method="POST" action="options.php">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    ...
                    <input required type="number" min=0 placeholder="Default Price" step=1 name="btcpw_default_pay_per_post_price" id="btcpw_general_pay_per_post_settings_price" value="<?php echo $default_price ?>">
                    ...
                    <div class="btcpw_pay_per_post_price_format">
                        ...
                        <?php foreach ($supported_btc_format as $format) : ?>
                            <div>
                                <input type="radio" id="btcpw_general_pay_per_post_settings_btc_format" name="btcpw_default_pay_per_post_btc_format" value="<?php echo $format ?>" <?php echo $used_format === $format ? 'checked' : '' ?>>
                                <label for="btcpw_general_pay_per_post_settings_btc_format"><?php echo $format ?></label>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input type="number" min="1" placeholder="Default Access Duration" name="btcpw_default_pay_per_post_duration" id="btcpw_general_pay_per_post_settings_duration" <?php echo $disable; ?> value="<?php echo $default_duration ?>">
                    <select required name="btcpw_default_pay_per_post_duration_type" id="btcpw_general_pay_per_post_settings_duration_type">
