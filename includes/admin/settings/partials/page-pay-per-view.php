    ...
    <div>
        <form method="POST" action="options.php">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input type="number" min="1" placeholder="Default Access Duration" name="btcpw_default_pay_per_view_duration" id="btcpw_default_pay_per_view_duration" <?php echo $disable; ?> value="<?php echo esc_attr($default_duration); ?>">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_preview_title_color" class="btcpw_pay_per_view_preview_title_color" name="btcpw_pay_per_view_preview_title_color" type="text" value="<?php echo $preview_title_color; ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_preview_description_color" class="btcpw_pay_per_view_preview_description_color" name="btcpw_pay_per_view_preview_description_color" type="text" value="<?php echo $preview_description_color; ?>" />
                </div>
            </div>
            <h3>Description</h3>
            <div class="row">
                ...
                <div class="col-80">
                    <textarea id="btcpw_pay_per_view_title" name="btcpw_pay_per_view_title"><?php echo $default_text; ?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_header_color" class="btcpw_pay_per_view_header_color" name="btcpw_pay_per_view_header_color" type="text" value="<?php echo $header_color; ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <textarea id="btcpw_pay_per_view_info" name="btcpw_pay_per_view_info"><?php echo $default_info; ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_info_color" class="btcpw_pay_per_view_info_color" name="btcpw_pay_per_view_info_color" type="text" value="<?php echo $info_color; ?>" />
                </div>
            </div>
            <h3>Button</h3>
            <div class="row">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_button" name="btcpw_pay_per_view_button" value="<?php echo $default_button; ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_button_color" class="btcpw_pay_per_view_button_color" name="btcpw_pay_per_view_button_color" type="text" value="<?php echo $button_color; ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="btcpw_pay_per_view_button_text_color" class="btcpw_pay_per_view_button_text_color" name="btcpw_pay_per_view_button_text_color" type="text" value="<?php echo $button_text_color; ?>" />
                </div>
            </div>
            ...
            <div id="btcpw_pay_per_view_paywall_help_button">
                ...
                <div class="row">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_show_help_link" class="btcpw_pay_per_view_show_help_link" name="btcpw_pay_per_view_show_help_link" type="checkbox" <?php echo checked($help); ?> value="<?php echo $help; ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-20">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_help_link" class="btcpw_pay_per_view_help_link" name="btcpw_pay_per_view_help_link" type="url" value="<?php echo $help_link; ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-20">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_help_link_text" class="btcpw_pay_per_view_help_link_text" name="btcpw_pay_per_view_help_link_text" type="text" value="<?php echo $help_text; ?>" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_show_additional_help_link" class="btcpw_pay_per_view_show_additional_help_link" name="btcpw_pay_per_view_show_additional_help_link" type="checkbox" <?php echo checked($additional_help); ?> value="<?php echo $additional_help; ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-20">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_additional_help_link" class="btcpw_pay_per_view_additional_help_link" name="btcpw_pay_per_view_additional_help_link" type="url" value="<?php echo $additional_help_link; ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-20">
                    ...
                    <div class="col-80">
                        <input id="btcpw_pay_per_view_additional_help_link_text" class="btcpw_pay_per_view_additional_help_link_text" name="btcpw_pay_per_view_additional_help_link_text" type="text" value="<?php echo $additional_help_text; ?>" />
                    </div>
                </div>
            </div>
        ...
        <div class="btcpw_pay_preview pay_per_view">
            ...
            <div class="btcpw_pay__preview_preview pay_per_view">
                <div class="btcpw_pay__preview_preview preview_img">
                    <img src="<?php echo BTCPAYWALL_PLUGIN_URL . 'assets/src/img/preview.png'; ?>" alt="Video preview">
                </div>
            ...
            <div class="btcpw_pay__footer_preview pay_per_view">
                <div>
                    <button disabled type="button" id="btcpw_pay__button_preview_pay_per_view" data-post_id="<?php echo get_the_ID(); ?>"><?php echo $default_button; ?></button>
                </div>
