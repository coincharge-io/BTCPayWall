    ...
    <div>
        <form method="POST" action="options.php">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input type="number" min="1" placeholder="Default Access Duration" name="btcpw_pay_per_view_duration" id="btcpw_pay_per_view_duration" <?php echo $disable; ?> value="<?php echo $default_duration ?>">
