...
<div class="btcpaywall-demo-explanation">
    <p><?php echo esc_html__('This page shows how to use shortcode to protect your video using your default settings. Click on the arrow next to the supported shortcode attributes to see how and which attributes can be overridden via shortcode. Omitting a shortcode attribute results in using the default setting for that attribute.', 'btcpaywall'); ?></p>
    ...
    <div class="btcpaywall-demo-shortcode-usage">
        <p><?php echo esc_html__('Shortcode attributes can be customized like this:', 'btcpaywall'); ?> <i>[btcpw_start_video pay_view_block='true' price='5' currency='EUR' duration='2' duration_type='week' display_name='true']</i></p>
        <ul>
