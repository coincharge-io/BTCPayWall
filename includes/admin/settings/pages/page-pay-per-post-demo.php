...
<div class="btcpaywall-demo-explanation">
    <p>This page shows how to use shortcode to protect your content by using your default settings. Click on the arrow next to the shortcode attributes to see which attributes can be overridden via shortcode. Omitting a shortcode attribute leads to using the default setting for that attribute.</p>
    <p><i>Example with custom attributes: [btcpw_start_content pay_block='true' price='5' currency='EUR' duration='2' duration_type='week' display_name='true']</i></p>
