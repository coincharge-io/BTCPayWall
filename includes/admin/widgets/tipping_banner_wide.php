 ...
 *
 * @package     BTCPayWall
 * @subpackage  Admin/Tipping_Banner_Wide
...
?>
        <style>
            ...
            #btcpw_widget_btcpw_skyscraper_tipping__button_wide:hover {
            ...
            #btcpw_widget_btcpw_skyscraper_button_wide .btcpw_widget.skyscraper-next-form.wide {
            ...
            #btcpw_widget_btcpw_skyscraper_button_wide .btcpw_widget.skyscraper-next-form.wide:hover {
                background: <?php echo esc_html($instance['continue_button_color_hover']);
                            ?>;
            }

            #btcpw_widget_btcpw_skyscraper_button_wide .btcpw_widget.skyscraper-previous-form.wide {
            ...
            #btcpw_widget_btcpw_skyscraper_button_wide .btcpw_widget.skyscraper-previous-form.wide:hover {
            ...
            <div class="btcpw_widget btcpw_skyscraper_banner wide">
                ...
                <div class="btcpw_widget btcpw_skyscraper_tipping_container wide">
                    <form method="POST" action="" id="btcpw_widget_skyscraper_tipping_form_wide">
                        <fieldset>
                            <h4><?php echo (!empty($instance['tipping_text']) ? printf(__('%s', 'btcpaywall'), esc_html($instance['tipping_text'])) : ''); ?>
                            </h4>
                            <div class="btcpw_widget btcpw_skyscraper_amount wide">
                                <?php foreach ($fixed_amount as $key => $value) : ?>
                                    <?php if ($fixed_amount[$key]['enabled'] === true) : ?>
                                        <div class="<?php echo printf(__('btcpw_widget btcpw_skyscraper_amount_%s wide', 'btcpaywall'), esc_attr("$key")); ?>">
                                            <div>
                                                <input type="radio" class="btcpw_widget btcpw_skyscraper_tipping_default_amount wide" id="<?php echo printf(__('btcpw_widget_%s_wide', 'btcpaywall'), esc_attr("$key")); ?>" name="btcpw_widget_btcpw_skyscraper_tipping_default_amount_wide" <?php echo $key == $index ? 'required' : ''; ?> value="<?php echo esc_attr($fixed_amount[$key]['amount'] . ' ' . esc_attr($fixed_amount[$key]['currency'])); ?>">
                                                <?php if (!empty($fixed_amount[$key]['amount'])) : ?>
                                                    <i class="<?php echo esc_attr($fixed_amount[$key]['icon']); ?>"></i>
                                                <?php endif; ?>
                                            </div>
                                            <label for="<?php echo $key; ?>"><?php echo esc_attr($fixed_amount[$key]['amount']) . ' ' . esc_attr($fixed_amount[$key]['currency']); ?></label>
                            ...
                            <div id="btcpw_widget_btcpw_skyscraper_button_wide">
                                ...
                                <?php if ($collect_data === true) : ?>
                                    <div>
                                        <input type="button" name="next" class="btcpw_widget skyscraper-next-form wide" value="<?php echo (!empty($instance['continue_button_text'])) ? printf(__('%s', 'btcpaywall'), esc_attr($instance['continue_button_text'])) : __('Continue', 'btcpaywall'); ?>" />
                                    </div>
                                <?php else : ?>
                                    <div>
                                        <button type="submit" id="btcpw_widget_btcpw_skyscraper_tipping__button_wide"><?php echo (!empty($instance['button_text'])) ? printf(__('%s', 'btcpaywall'), esc_html($instance['button_text'])) : __('Tip', 'btcpaywall'); ?></button>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <?php if ($collect_data === true) : ?>
                            <fieldset>
                                ...
                                <div id="btcpw_widget_btcpw_skyscraper_button_wide">
                                    <div>
                                        <input type="button" name="previous" class="btcpw_widget skyscraper-previous-form wide" value="<?php echo (!empty($instance['previous_button_text'])) ? printf(__('%s', 'btcpaywall'), esc_attr($instance['previous_button_text'])) : __('Previous', 'btcpaywall'); ?>" />
                                    </div>
                                    <div>
                                        <button type="submit" id="btcpw_widget_btcpw_skyscraper_tipping__button_wide"><?php echo (!empty($instance['button_text'])) ? printf(__('%s', 'btcpaywall'), esc_html($instance['button_text'])) : __('Tip', 'btcpaywall'); ?></button>
                                    </div>
    ...
    public function form($instance)
    {
        ...
        $supported_currencies = BTCPayWall::CURRENCIES;
        $title = !empty($instance['title']) ? $instance['title'] : __('Support my work', 'btcpaywall');

        $description = !empty($instance['description']) ? $instance['description'] : '';


        $currency = !empty($instance['currency']) ? $instance['currency'] : 'SATS';

        $background_color = !empty($instance['background_color']) ? $instance['background_color'] : '#E6E6E6';
        $title_text_color = !empty($instance['title_text_color']) ? $instance['title_text_color'] : '#FFFFFF';

        $tipping_text = !empty($instance['tipping_text']) ? $instance['tipping_text'] : __('Enter Tipping Amount', 'btcpaywall');
        $tipping_text_color = !empty($instance['tipping_text_color']) ? $instance['tipping_text_color'] : '#000000';
        $redirect = !empty($instance['redirect']) ? $instance['redirect'] : '';
        $amount = !empty($instance['amount']) ? $instance['amount'] : '';
        $description_color = !empty($instance['description_color']) ? $instance['description_color'] : '#000000';

        $button_text = !empty($instance['button_text']) ? $instance['button_text'] : __('Tipping now', 'btcpaywall');
        $button_text_color = !empty($instance['button_text_color']) ? $instance['button_text_color'] : '#FFFFFF';

        $button_color = !empty($instance['button_color']) ? $instance['button_color'] : '#FE642E';
        ...
        $display_name = !empty($instance['display_name']) ? $instance['display_name'] : 'true';
        $mandatory_name = !empty($instance['mandatory_name']) ? $instance['mandatory_name'] : '';

        $display_email = !empty($instance['display_email']) ? $instance['display_email'] : 'true';
        $mandatory_email = !empty($instance['mandatory_email']) ? $instance['mandatory_email'] : '';

        $display_address = !empty($instance['display_address']) ? $instance['display_address'] : 'true';
        $mandatory_address = !empty($instance['mandatory_address']) ? $instance['mandatory_address'] : '';

        $display_phone = !empty($instance['display_phone']) ? $instance['display_phone'] : 'true';
        $mandatory_phone = !empty($instance['mandatory_phone']) ? $instance['mandatory_phone'] : '';

        $display_message = !empty($instance['display_message']) ? $instance['display_message'] : 'true';
        $mandatory_message = !empty($instance['mandatory_message']) ? $instance['mandatory_message'] : '';

        $value1_enabled = !empty($instance['value1_enabled']) ? $instance['value1_enabled'] : 'true';
        $value1_amount = !empty($instance['value1_amount']) ? $instance['value1_amount'] : '1000';
        $value1_icon = !empty($instance['value1_icon']) ? $instance['value1_icon'] : 'fas fa-coffee';
        $value1_currency = !empty($instance['value1_currency']) ? $instance['value1_currency'] : '';

        $value2_enabled = !empty($instance['value2_enabled']) ? $instance['value2_enabled'] : 'true';
        $value2_amount = !empty($instance['value2_amount']) ? $instance['value2_amount'] : '2000';
        $value2_icon = !empty($instance['value2_icon']) ? $instance['value2_icon'] : 'fas fa-beer';
        $value2_currency = !empty($instance['value2_currency']) ? $instance['value2_currency'] : '';

        $value3_enabled = !empty($instance['value3_enabled']) ? $instance['value3_enabled'] : 'true';
        $value3_amount = !empty($instance['value3_amount']) ? $instance['value3_amount'] : '3000';
        $value3_icon = !empty($instance['value3_icon']) ? $instance['value3_icon'] : 'fas fa-cocktail';
        $value3_currency = !empty($instance['value3_currency']) ? $instance['value3_currency'] : '';

        $free_input = !empty($instance['free_input']) ? $instance['free_input'] : 'true';
    ...
    ?>
        ...
        <div class="tipping_banner wide">
            ...
            <div class="row">
                <div>
                    <label for="<?php echo esc_attr($this->get_field_id('redirect')); ?>"><?php echo __('Link to Thank you page', 'btcpaywall'); ?></label>
                </div>
                <div>
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <?php if ($background) : ?>
                        <button id="btcpw_tipping_button_image_background_banner_wide" class="widget-tipping-basic-upload_box_image_wide" name="btcpw_tipping_button_image_background"><img width="100" height="100" alt="Tipping banner wide background" src="<?php echo esc_url($background[0]); ?>" /></a></button>
                        <button type="button" class="widget-tipping-basic-remove_box_image_wide">
                    ...
                    <?php else : ?>
                        ...
                        <button type="button" class="widget-tipping-basic-remove_box_image_wide" style="display:none"><?php echo esc_html__('Remove', 'btcpaywall'); ?></button>
                        <input type="hidden" class="widget-tipping-basic-background_id_wide" id="<?php echo esc_attr($this->get_field_id('background_id')); ?>" name="<?php echo esc_attr($this->get_field_name('background_id')); ?>" type="text" value="<?php echo esc_attr($background_id); ?>" />
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('button_color_hover')); ?>" class="widget-tipping-basic-button_color_hover_wide" name="<?php echo esc_attr($this->get_field_name('button_color_hover')); ?>" type="text" value="<?php echo esc_attr($button_color_hover); ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('continue_button_text_color')); ?>" class="widget-tipping-basic-continue_button_text_color_wide" name="<?php echo esc_attr($this->get_field_name('continue_button_text_color')); ?>" type="text" value="<?php echo esc_attr($continue_button_text_color); ?>" />
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('continue_button_color')); ?>" class="widget-tipping-basic-continue_button_color_wide" name="<?php echo esc_attr($this->get_field_name('continue_button_color')); ?>" type="text" value="<?php echo esc_attr($continue_button_color); ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('continue_button_color_hover')); ?>" class="widget-tipping-basic-continue_button_color_hover_wide" name="<?php echo esc_attr($this->get_field_name('continue_button_color_hover')); ?>" type="text" value="<?php echo esc_attr($continue_button_color_hover); ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('previous_button_text_color')); ?>" class="widget-tipping-basic-previous_button_text_color_wide" name="<?php echo esc_attr($this->get_field_name('previous_button_text_color')); ?>" type="text" value="<?php echo esc_attr($previous_button_text_color); ?>" />
            ...
            <div class="row">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('previous_button_color')); ?>" class="widget-tipping-basic-previous_button_color_wide" name="<?php echo esc_attr($this->get_field_name('previous_button_color')); ?>" type="text" value="<?php echo esc_attr($previous_button_color); ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col-20">
                ...
                <div class="col-80">
                    <input id="<?php echo esc_attr($this->get_field_id('previous_button_color_hover')); ?>" class="widget-tipping-basic-previous_button_color_hover_wide" name="<?php echo esc_attr($this->get_field_name('previous_button_color_hover')); ?>" type="text" value="<?php echo esc_attr($previous_button_color_hover); ?>" />
                </div>
            </div>
            <h3><?php echo __('Fixed amount'); ?></h3>
            ...
            <h4><?php echo __('Donor information', 'btcpaywall'); ?></h4>
            <div class="row">
                <div class="col-20">
