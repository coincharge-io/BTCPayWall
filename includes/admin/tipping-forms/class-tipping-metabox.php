...
?>
        <div class="btcpaywall_metabox_wrap">
            ...
            <div id="tab-1" class="btcpaywall_options_wrap btcpaywall_tabset current">
                ...
                <h2>Header</h2>
                <div class="btcpaywall_template_header">
                    ...
                    <fieldset class="btcpaywall_field_wrap"><label>Step 1 color</label>
                    ...
                    <fieldset class="btcpaywall_field_wrap"><label>Step 2</label>
                    ...
                    <div class="btcpaywall_template_main">
                        <fieldset class="btcpaywall_field_wrap"><label>Tipping text</label>
                            <input value="bla" />
                        </fieldset>
                        <fieldset class="btcpaywall_field_wrap"><label>Tipping text color</label>
                            <input value="bla" />
                        </fieldset>
                        <fieldset class="btcpaywall_field_wrap"><label>Input background color</label>
                            <input value="bla" />
                        </fieldset>
                    </div>
                    <h2>Footer</h2>
