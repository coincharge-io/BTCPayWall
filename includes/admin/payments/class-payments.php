...
class Payments_Table extends WP_List_Table
{
    ...
    {
        return '<a href="' . add_query_arg('id', $item['invoice_id'], admin_url('admin.php?page=btcpw_payments&view=view-payment')) . '">' . esc_html__('View Payment Details', 'btcpaywall') . '</a>';
    }
